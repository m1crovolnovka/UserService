...
public class PaymentCardController {
    ...
    @GetMapping
    public ResponseEntity<Page<PaymentCardResponseDto>> getAll(@RequestParam(required = false) String cardNumber,
                                                               @RequestParam(required = false) String holderName,
                                                               Pageable pageable) {
        return ResponseEntity.ok(cardService.getAll(cardNumber,holderName, pageable));
    }
